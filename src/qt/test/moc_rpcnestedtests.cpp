...
struct qt_meta_stringdata_RPCNestedTests_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_RPCNestedTests_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RPCNestedTests_t qt_meta_stringdata_RPCNestedTests = {
    {
QT_MOC_LITERAL(0, 0, 14), // "RPCNestedTests"
QT_MOC_LITERAL(1, 15, 14), // "rpcNestedTests"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "RPCNestedTests\0rpcNestedTests\0"
};
...
const QMetaObject RPCNestedTests::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_RPCNestedTests.data,
      qt_meta_data_RPCNestedTests,  qt_static_metacall, nullptr, nullptr}
};
...
void *RPCNestedTests::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RPCNestedTests.stringdata0))
