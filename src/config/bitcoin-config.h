...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Arowanacoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Arowanacoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/arowanacoin/arowanacoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Arowanacoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Arowanacoin Core 2.1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "arowanacoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://arowanacoin.org/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "2.1.0.1"
