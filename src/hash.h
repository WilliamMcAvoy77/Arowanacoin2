...
#include <vector>
#include <crypto/yespower-arwn/yespower.h>

typedef uint256 ChainCode;

/** A hasher class for Arowanacoin's 256-bit hash (double SHA-256). */
class CHash256 {
private:
    CSHA256 sha;
public:
...
/** A hasher class for Arowanacoin's 160-bit hash (SHA-256 + RIPEMD-160). */
class CHash160 {
private:
    CSHA256 sha;
public:
